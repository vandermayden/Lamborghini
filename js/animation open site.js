var clock = 0; //счетчик для анимации при входе

function timer() { //начальная анимация при открытии приложения
	document.getElementById('top_line').style.display = 'none';
	document.getElementById('wrapper').style.display = 'none';	
	document.getElementById('bottom_line').style.display = 'none';
	document.getElementById('animation_wrapper_open_site').style.display = '';	
	...
	if (clock == 5) {		
		document.getElementById('animation-list-open-site').style.top = '47.1%';
	...
	if (clock == 6) {
		document.getElementById('animation-list-open-site').style.top = '45.6%';
	...
	if (clock == 7) {
		document.getElementById('animation-list-open-site').style.top = '41.1%';
	...
	if (clock == 8) {
		document.getElementById('animation-list-open-site').style.top = '32.8%';
	...
	if (clock == 9) {
		document.getElementById('animation-list-open-site').style.top = '15.6%';
...
animation_loading.addEventListener('click', timer_1);	//кнопка loading (animation_loading) или иконка Lamborghini (lamborghini_logo_picture_1) для запуска анимации при входе
function timer_1() {	
	...
	if (clock == 43) {
		document.getElementById('animation-list-open-site').style.top = '14.1%';
		document.getElementById('animation-list-open-site').style.width = '800px';
	...
	if (clock == 45) {
		document.getElementById('animation_wrapper_open_site').style.background = '#fff';
	}
	if (clock == 47) {
		document.getElementById('animation-list-open-site').style.top = '12.6%';
		document.getElementById('animation-list-open-site').style.width = '800px';
	...
	if (clock == 53) {
		document.getElementById('animation-list-open-site').style.top = '1.3%';
	...
	if (clock == 55) {
		document.getElementById('animation-list-open-site').style.top = '0%';
		...
		document.getElementById('footer_animation_pic').style.background = 'url(../lamborghini/img/foot_img_61.png) no-repeat';		
	}
	if (clock == 57) {
	...
	if (clock == 71) {	
		...
		document.getElementById('animation_wrapper_open_site').style.display = 'none';
...
animation_scip.addEventListener('click', go_to_site);	//кнопка scip (animation_scip) для открытия приложения без анимации при входе
function go_to_site() {	
	document.getElementById('animation_wrapper_open_site').style.display = 'none';
	document.getElementById('top_line').style.display = '';
	document.getElementById('wrapper').style.display = '';	
